...
收藏网址 <a href="https://user.marsjsq.com" target=”_blank”>user.marsjsq.com</a>后续如有更换域名也会优先更新此处链接<br>
</p>
';
...
# │                                              客服系统 设置                                                │
# └──────────────────────────────────────────────────────────────────────────────────────────────────────────┘
$_MT['enable_cust']                 = 'chatra';                   // 使用哪种客服系统  none: 关闭 目前支持: crisp | chatra
...
$_MT['chatra_id']                   = 'wjj28g7MzwHuRz3Mr';  // Chatra 的 ChatraID，可以在 Chatra 提供的网站代码里找到
...
$_MT['shop_plan'] = array(
    ...
    '专线套餐' => array(            // 需要多个套餐可以自己复制array增加到下面
        '描述' => array(
            '月付' => 5,
            '季度' => 6,
            '年付' => 8,
