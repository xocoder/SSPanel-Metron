...
';
$_ENV['version'] = 5;    //仅当涉及【需要修改config以外的文件】时才需要+1，站长勿动


//基本设置--------------------------------------------------------------------------------------------
$_ENV['key'] = '1145asdfasdf141919aa810';                //!!! 瞎 jb 修改此key为随机字符串确保网站安全 !!!
$_ENV['debug'] = false;                          //正式环境请确保为 false
$_ENV['appName'] = '天行加速器';                      //站点名称
$_ENV['baseUrl'] = 'https://user.marsjsq.com';               //站点地址
$_ENV['muKey'] = '3a7caa4b32ffb47e7bb2d0ec7d097110';               //用于校验魔改后端请求，可以随意修改，但请保持前后端一致，否则节点不能工作！
...
//邮件设置--------------------------------------------------------------------------------------------
$_ENV['mailDriver'] = 'mailgun';      //发送邮件方式：none / mailgun / smtp / sendgrid / aliyunweb
$_ENV['sendPageLimit'] = 50;          //发信分页 解决大站发公告超时问题
$_ENV['email_queue']     = true;        //如题，自动计划任务邮件使用队列 需要每分钟执行 php xcat Job SendMail

# mailgun
$_ENV['mailgun_key'] = 'e78e85660fb94a224d13040ae4cc9994-4f207195-b5ec7f14';
$_ENV['mailgun_domain'] = 'sandbox481144ff27fd468586f22d0a05d3d846.mailgun.org';
$_ENV['mailgun_sender'] = 'service@marsjsq.com';
...
$_ENV['mylivechat_id'] = '19395957';      //客服系统ID
...
$_ENV['SPEEDPay']=[
    'partner' => "1084", //商户号
    'key' => "V4GcZzg99gk43LbV4I9G9cG22IU1G594", //商户key
    'partner1'=>"", //备用商户号
    'key'=>"", //备用商户key
